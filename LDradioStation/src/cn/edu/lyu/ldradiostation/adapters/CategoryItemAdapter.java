...
public class CategoryItemAdapter extends BaseAdapter {
	...
	public void setData(List<Radios> infos1, int type) {
		if (type == 0) {
			// 下拉，数据追加到顶部
			Radios.addAll(0, infos1);
		} else {
			// 上拉，数据追加到低部
			Radios.addAll(infos1);
		}
	...
	public View getView(int arg0, View convertView, ViewGroup arg2) {
		...
		bitmapUtils.display(viewHolder.categoryItemView, Paths.RADIO_IMG_PATH+Radios.get(arg0)
				.getImage(), new BitmapLoadCallBack<CategoryItemView>() {

			@Override
			public void onLoadCompleted(CategoryItemView container, String uri,
			...
			@Override
			public void onLoadFailed(CategoryItemView container, String uri,
					Drawable drawable) {
				// TODO Auto-generated method stub
